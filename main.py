        ...
        def addadmin():
            def adminusname():
                ...
                if u in admin or u in supervis or u in standard:
                    ...
                    tk.Button(master=aa,text="Confirm Password", bg = 'blue', fg = 'white', command=adminuserback,width=25).grid(row=2,column=3)
            aa=tk.Tk()
            ...
            a3=tk.Button(master=aa,text="Confirm Username", bg = 'deeppink', fg = 'white', width=25,command=adminusname).grid(row=1,column=3)
        def addsuper():
            def superusname():
                def superuserback():
                    p=passw.get()                                                             
                ...
                if u in admin or u in supervis or u in standard:
                    ...
                    passw=tk.Entry(master=aa,show='*')
                    passw.grid(row=2,column=1)
                    tk.Button(master=aa,text="Confirm Password", bg = 'blue', fg = 'white', command=superuserback,width=25).grid(row=2,column=3)
            aa=tk.Tk()
            aa.title("Add A Supervisor")
            tk.Label(master=aa,text="Enter the Username").grid(row=1,column=0)
            usname=tk.Entry(master=aa)
            usname.grid(row=1,column=1)
            a3=tk.Button(master=aa,text="Confirm Username", bg = 'deeppink', fg = 'white', width=25,command=superusname).grid(row=1,column=3)
        def addstand():
            def standusname():
                def standuserback():
                    p=passw.get()                                                             
                ...
                if u in admin or u in supervis or u in standard:
                    ...
                    passw=tk.Entry(master=aa,show='*')
                    passw.grid(row=2,column=1)
                    tk.Button(master=aa,text="Confirm Password", bg = 'deeppink', fg = 'white', command=standuserback,width=25).grid(row=2,column=3)
            aa=tk.Tk()
            aa.title("Add A Standard User")
            tk.Label(master=aa,text="Enter the Username").grid(row=1,column=0)
            usname=tk.Entry(master=aa)
            usname.grid(row=1,column=1)
            a3=tk.Button(master=aa,text="Confirm Username", bg = 'blue', fg = 'white', width=25,command=standusname).grid(row=1,column=3)
        addusersc=tk.Tk()
...
def bookticket():
    booksc=tk.Tk()     
    booksc.title("Book A Ticket")  
    clicked = tk.StringVar()  
    clicked.set("Select Flight")
    options = list(scheduled.keys())
    drop = tk.OptionMenu( booksc , clicked , *options )
    drop.pack()
    updatepopup=tk.Tk()
    updatepopup.title("Ticket has been booked!!")
    tk.Label(master=updatepopup,text="Ticket has been booked!!").grid(row=0,column=0)
    booksc.destroy()           

def cancelticket():
    cancelticketsc=tk.Tk()     
    cancelticketsc.title("Cancel A Ticket")    
    tk.Label(master=cancelticketsc,text="Enter The Flight Number").grid(row=1,column=0)
    flightnum=tk.Entry(master=cancelticketsc)
    flightnum.grid(row=1,column=1)   
    updatepopup=tk.Tk()
    updatepopup.title("Ticket has been cancelled!! and REFUND of 30%  has been initiated!!")
    tk.Label(master=updatepopup,text="Ticket has been cancelled!! and REFUND of 30%  has been initiated!!").grid(row=0,column=0)
    cancelticketsc.destroy()           
...
def admain():#admin control panel
    ...
    tk.Button(master=admainsc,text="View The Details Of Flights", bg = 'red', fg = 'white', command=view).grid(row=1,column=1)
    tk.Button(master=admainsc,text="Switch User", bg = 'blue', fg = 'white', command=switchuserad).grid(row=2,column=1)
    tk.Button(master=admainsc,text="Cancel A Flight", bg = 'deeppink', fg = 'white' ,command=cancel).grid(row=4,column=1)
    tk.Button(master=admainsc,text="Manage Users", bg = 'blue', fg = 'white', command=manageuser).grid(row=5,column=1)
    tk.Button(master=admainsc,text="Exit The Program", bg = 'black', fg = 'white', command=exit).grid(row=6,column=1)
    tk.Button(master=admainsc,text="Update/Add A Flight", bg = 'blue', fg = 'white', command=update).grid(row=3,column=1)
...
def supmain():#supervisor control panel
    ...
    tk.Button(master=supmainsc,text="View The Details Of Flights", bg = 'red', fg = 'white', command=view).grid(row=1,column=1)
    tk.Button(master=supmainsc,text="Switch User", bg = 'yellow', fg = 'red', command=switchusersup).grid(row=2,column=1)
    tk.Button(master=supmainsc,text="Cancel A Flight", bg = 'blue', fg = 'deeppink', command=cancel).grid(row=4,column=1)
    tk.Button(master=supmainsc,text="Exit The Program", bg = 'black', fg = 'white', command=exit).grid(row=5,column=1)
    tk.Button(master=supmainsc,text="Update/Add A Flight", bg = 'blue', fg = 'deeppink', command=update).grid(row=3,column=1)
    supmainsc.mainloop()
...
def stamain():#standard user control panel
    ...
    tk.Button(master=stamainsc,text="View The Details Of Flights", bg = 'green', fg = 'white', command=view).grid(row=2,column=0)
    tk.Button(master=stamainsc,text="Switch User", bg = 'blue', fg = 'white', command=switchuserstand).grid(row=3,column=0)
    tk.Button(master=stamainsc,text="Exit The Program", bg = 'black', fg = 'white', command=exit).grid(row=6,column=0)
    tk.Button(master=stamainsc,text="Book A Ticket", bg = 'blue', fg = 'deeppink', command=bookticket).grid(row=4, column=0)
    tk.Button(master=stamainsc,text="Cancel A Ticket", bg = 'blue', fg = 'deeppink', command=cancelticket).grid(row=5, column=0)
...
def login():#login function
    def userver():        
        ...
        if not(a in admin or a in supervis or a in standard):
            ...
            a3=tk.Button(master=loginsc,text="Confirm Password", bg = 'deeppink', fg = 'white', width=25,command=passver).grid(row=2,column=2)   
    loginsc=tk.Tk()
    loginsc.title("Login")
    ...
    a22=tk.Button(master=loginsc,text="Confirm Username", bg = 'blue', fg = 'white', width=25,command=userver).grid(row=1,column=2)
    loginsc.mainloop()
login()
